 ...
 * Sometimes the holes are protected by an {@link EnergyBarrierAnimation}, making it even more difficult to fly through.
...
public class Wall extends GameObject {
     ...
     * This class serves as a Wrapper for several {@code WallRow} GameObjects that are staked on top of each other.
     *
     * @param gameView             GameView to show the game object on.
     * @param gamePlayManager      reference to the gamePlayManager
     * @param dynamicWall a BlockGraphic String for each row of the Wall & the corresponding hitbox (created by {@link WallBlockGraphicUtils#generateDynamicWall(String)})
     ...
     */
    public Wall(GameView gameView, GamePlayManager gamePlayManager, WallBlockGraphicUtils.DynamicWall dynamicWall, double distanceFromSpawnLine, double spawnLineInter) {
