...
public final class GameSettings {
    ...
    /* ##################################
         TRAVEL PATH SPECIFIC CONSTANTS
       ################################## */
    /**
     ...
     *
     * @see thd.gameobjects.base.GameObject
     */
    ...
    /* ##################################
           PLAYER SPECIFIC CONSTANTSs
       ################################## */
    /**
     * an interpolation factor for where on the {@link TravelPathCalculator#getPlayerMovementLine()} the player will spawn.
     */
    public static final double PLAYER_MOVEMENT_LINE_INTERPOLATION_FACTOR = 0.5;
    /**
     * This is the maximum altitude that the Player can fly up to.
     */
    public static final double MAX_PLAYER_ALTITUDE = 200;
    /**
