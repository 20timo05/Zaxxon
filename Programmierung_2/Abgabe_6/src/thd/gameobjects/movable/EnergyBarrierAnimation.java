...
class EnergyBarrierAnimation extends GameObject {
     ...
     */
    EnergyBarrierAnimation(GameView gameView, GamePlayManager gamePlayManager, int altitudeLevel, double[] dimensions) {
    ...
    void updatePosition(Position towerPosition) {
        ...
        newPosition.up(altitudeLevel * GameSettings.MAX_PLAYER_ALTITUDE);
