...
public abstract class GameObject {
    ...
    protected double inter; // for stationary GameObjects
    ...
    /**
     * Crates a new Stationary GameObject.
     *
     * @param gameView        GameView to show the game object on.
     * @param gamePlayManager reference to the gamePlayManager
     * @param inter             interpolation factor: where to spawn the object
     */
    public GameObject(GameView gameView, GamePlayManager gamePlayManager, double inter) {
        ...
        stationaryMovementPattern = new StationaryMovementPattern(inter);
    ...
    public boolean equals(Object o) {
        ...
        return position.equals(other.position)
                ...
                && Double.compare(inter, other.inter) == 0
                && hasDespawned == other.hasDespawned;
    }

    @Override
    public int hashCode() {
        return Objects.hash(position, targetPosition, speedInPixel, rotation, size, width, height, inter, hasDespawned);
    }
}