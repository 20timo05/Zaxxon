...
import thd.game.managers.TravelPathCalculator;
...
public class DebuggingLines extends GameObject {
    /**
     * Initializes a {@code DebuggingLines} object.
     *
     * @param gameView to display the {@code DebuggingLines} object on
     */
     ...
     */
    public DebuggingLines(GameView gameView) {
        super(gameView);
