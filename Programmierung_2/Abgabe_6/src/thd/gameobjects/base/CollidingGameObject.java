...
public abstract class CollidingGameObject extends GameObject {
    ...
    protected static final int MAX_ALTITUDE_LEVEL = 5;
     ...
     */
    public CollidingGameObject(GameView gameView, GamePlayManager gamePlayManager, int altitudeLevel, boolean isRectangular, double inter) {
