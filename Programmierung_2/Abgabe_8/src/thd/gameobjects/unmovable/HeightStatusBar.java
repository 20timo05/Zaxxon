...
public class HeightStatusBar extends GameObject {
     ...
     *
     * @param zaxxonFighterAltitudeInterpolation altitude interpolation factor of the {@link thd.gameobjects.movable.ZaxxonFighter}
     */
    public void updateStatus(double zaxxonFighterAltitudeInterpolation) {
        this.playerHeightInterpolation = zaxxonFighterAltitudeInterpolation;
    }
