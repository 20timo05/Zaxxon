...
public class Wall extends GameObject {
     ...
     * @param dynamicWall a BlockGraphic String for each row of the Wall & the corresponding hitbox (created by {@link thd.game.utilities.WallBlockGraphicUtils#generateDynamicWall(String)})
     * @see thd.game.utilities.WallBlockGraphicUtils
     */
